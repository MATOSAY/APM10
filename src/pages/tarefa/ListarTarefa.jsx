...
// Função para criar os dados das tarefas
...
// Dados iniciais da lista de tarefas
const initialRows = [
    ...
    <>
      <Card>
        ...
        <CardActions>
          ...
          <Button size="small" variant="outlined" onClick={() => alert('Cancelar')}>
            Cancelar
          </Button>
        </CardActions>
      </Card>

      <Modal open={open} onClose={handleClose} aria-labelledby="modal-criar-tarefa" aria-describedby="modal-descricao-criar-tarefa">
        <div>
          <CriarTarefa handleClose={handleClose} tarefas={tarefas} setTarefas={setTarefas} />
        </div>
      </Modal>

      <Modal open={openEditar} onClose={handleCloseEditar} aria-labelledby="modal-editar-tarefa" aria-describedby="modal-descricao-editar-tarefa">
        <div>
          <EditarTarefa
